...
export const SEARCH_TOOL_DESCRIPTION =
  "Search the web with Firecrawl and return full content from results. Output is limited to 50KB or 2000 lines; complete truncated output is saved to a temporary file.";
